package xpath;
/*Create dynamic xpath following first 9 ways your teacher taught. For each type, create 5 examples from any website. 
 * Write them by commenting in a class inside a package and push to the github. Paste the link below.
 */
